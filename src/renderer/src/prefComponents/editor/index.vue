  ...
  <div class="pref-editor">
    ...
    <compound>
      ...
      <template #children>
        ...
        ></bool>
        <bool
          :description="t('preferences.editor.writingBehavior.surroundSelection')"
          :notes="t('preferences.editor.writingBehavior.surroundSelectionNotes')"
          :bool="surroundSelection"
          :on-change="(value) => onSelectChange('surroundSelection', value)"
        ></bool>
      </template>
    </compound>
