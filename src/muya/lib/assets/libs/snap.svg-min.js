...
;(!(function (a) {
  ...
  let j = { n: {} }
  let k = function () {
    for (let a = 0, b = this.length; b > a; a++) if (typeof this[a] !== 'undefined') return this[a]
  }
  let l = function () {
    for (let a = this.length; --a;) if (typeof this[a] !== 'undefined') return this[a]
  }
  ...
  let o =
    Array.isArray ||
    function (a) {
      return a instanceof Array || m.call(a) == '[object Array]'
    }
  ;((eve = function (a, d) {
    let e
    let f = c
    let g = Array.prototype.slice.call(arguments, 2)
    let h = eve.listeners(a)
    let j = 0
    let m = []
    let n = {}
    let o = []
  ...
  (eve.off = eve.unbind =
      function (a, b) {
        ...
        let c = o(a) ? (o(a[0]) ? a : [a]) : n(a).split(g)
        if (c.length > 1) for (var d = 0, i = c.length; i > d; d++) eve.off(c[d], b)
          ...
          for (d = 0, i = c.length; i > d; d++) {
            for (p = 0; p < r.length; p += m.length - 2) {
              if (((m = [p, 1]), (k = r[p].n), c[d] != h)) { k[c[d]] && (m.push(k[c[d]]), s.unshift({ n: k, name: c[d] })) } else for (l in k) k[e](l) && (m.push(k[l]), s.unshift({ n: k, name: l }))
              r.splice.apply(r, m)
            }
          }
...
(function (a, b) {
  ...
  let c = (function (b) {
    ...
    return (
      ...
      (s.easeinout = function (a) {
        ...
        if (a == 0) return 0
        let b = 0.48 - a / 1.04
        let c = Math.sqrt(0.1734 + b * b)
        let d = c - b
        let e = Math.pow(Math.abs(d), 1 / 3) * (d < 0 ? -1 : 1)
        let f = -c - b
        let g = Math.pow(Math.abs(f), 1 / 3) * (f < 0 ? -1 : 1)
        let h = e + g + 0.5
  ...
  let d = (function (a) {
    ...
    function d(a, b) {
      if (b) {
        if (
          (a == '#text' && (a = y.doc.createTextNode(b.text || b['#text'] || '')),
          a == '#comment' && (a = y.doc.createComment(b.text || b['#text'] || '')),
    ...
    function e(a, b) {
      return (
        ...
        b == 'finite'
          ? isFinite(a)
          : b == 'array' && (a instanceof Array || (Array.isArray && Array.isArray(a)))
            ? !0
            : (b == 'null' && a === null) ||
                (b === typeof a && a !== null) ||
                (b == 'object' && a === Object(a)) ||
    ...
    function f(a) {
      ...
      for (let c in a) a[z](c) && (b[c] = f(a[c]))
      return b
    }
    function h(a, b) {
      for (let c = 0, d = a.length; d > c; c++) if (a[c] === b) return a.push(a.splice(c, 1)[0])
    }
    function i(a, b, c) {
      function d() {
        let e = Array.prototype.slice.call(arguments, 0)
        let f = e.join('␀')
        let g = (d.cache = d.cache || {})
        let i = (d.count = d.count || [])
        return g[z](f)
          ? (h(i, f), c ? c(g[f]) : g[f])
      ...
      return (
        (a = a.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function (a, c, d) {
          return (
            ...
            c == 'scale' &&
                (d.length > 2 ? (d = d.slice(0, 2)) : d.length == 2 && d.push(0, 0),
            ...
            : o == 't' && n == 3
              ...
              : o == 'r'
                ...
                : o == 's'
                  ? n == 2 || n == 3
                    ? ((l = l || b),
                    e.scale(m[1], m[n - 1], l.x + l.width / 2, l.y + l.height / 2))
                    : n == 4
                      ? p
                        ? ((j = q.x(m[2], m[3])),
                        (k = q.y(m[2], m[3])),
                  ...
                  : o == 'm' && n == 7 && e.add(m[1], m[2], m[3], m[4], m[5], m[6])
        }
      }
      return e
    }
    ...
    function q(a, b, c) {
      ...
      function g(d, e) {
        b == null ? (i[d] = e(a.attr(d) || 0)) : d == b && (i = e(c == null ? a.attr(d) || 0 : c))
      }
      let h = p(a).node
      var i = {}
    ...
    function s(a) {
      ...
      ) { for (let e in v.prototype) v.prototype[z](e) && (this[e] = v.prototype[e]) }
    }
    function t(a) {
      this.node = a
    }
      ...
      return a
        ? a instanceof s || a instanceof t
          ...
          : a.tagName && a.tagName.toLowerCase() == 'svg'
            ? new v(a)
            : a.tagName && a.tagName.toLowerCase() == 'object' && a.type == 'image/svg+xml'
    ...
    function x(a, b) {
      for (let c = 0, d = a.length; d > c; c++) {
        let e = { type: a[c].type, attr: a[c].attr() }
        let f = a[c].children()
    ...
    let L = ((c._.separator = /[,\s]+/), /[\s]*,[\s]*/)
    let M = { hs: 1, rg: 1 }
    let N = /([a-z])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\s]*,?[\s]*)+)/gi
    let O = /([rstm])[\s,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\s]*,?[\s]*)+)/gi
    let P = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\s]*,?[\s]*/gi
    let Q = 0
    let R = 'S' + (+new Date()).toString(36)
    var S = function (a) {
    ...
    (c.getRGB = i(function (a) {
      ...
      if (a == 'none') return { r: -1, g: -1, b: -1, hex: 'none', toString: Z }
      ...
      return j
        ...
        j[5]
          ...
          (f = B(i[2])),
          i[2].slice(-1) == '%' && (f /= 100),
          (i[0].slice(-3) == 'deg' || i[0].slice(-1) == '°') && (b /= 360),
    ...
    var W = function (a) {
      let b = y.doc.getElementsByTagName('head')[0] || y.doc.getElementsByTagName('svg')[0]
      let c = 'rgb(255, 0, 0)'
      return (W = i(function (a) {
        if (a.toLowerCase() == 'red') return c
        ;((b.style.color = c), (b.style.color = a))
        let d = y.doc.defaultView.getComputedStyle(b, I).getPropertyValue('color')
        return d == c ? null : d
      }))(a)
    }
    let X = function () {
    ...
    (c.parsePathString = function (a) {
      ...
      let d = { a: 7, c: 6, o: 2, h: 1, l: 2, m: 2, r: 4, q: 4, s: 4, t: 2, v: 1, u: 3, z: 0 }
      let f = []
      return (
        ...
        f.length ||
              A(a).replace(N, function (a, b, c) {
                ...
                if (
                  ...
                  g == 'm' &&
                    e.length > 2 &&
                    (f.push([b].concat(e.splice(0, 2))), (g = 'l'), (b = b == 'm' ? 'l' : 'L')),
                  g == 'o' && e.length == 1 && f.push([b, e[0]]),
                  g == 'r')
                ) { f.push([b].concat(e)) } else for (; e.length >= d[g] && (f.push([b].concat(e.splice(0, d[g]))), d[g]););
              }),
        ...
        if (V[z](a)) {
          ...
          let c = b.node
              ;((b.type != 'svg' && !c.ownerSVGElement) ||
                (b.type == 'svg' &&
                  (!c.parentNode || ('ownerSVGElement' in c.parentNode && !c.ownerSVGElement)))) &&
                delete V[a]
        }
      }
    }, 1e4),
    (s.prototype.attr = function (a, c) {
      ...
      for (let l in a) a[z](l) && b('snap.util.attr.' + l, d, a[l])
      return d
    }),
    (c.parse = function (a) {
      let b = y.doc.createDocumentFragment()
      let c = !0
      let d = y.doc.createElement('div')
      if (
        ((a = A(a)),
    ...
    b.on('snap.util.getattr', function () {
      ...
      let c = a.replace(/[A-Z]/g, function (a) {
    ...
    var ba = {
      ...
      let f = c.replace(/-(\w)/gi, function (a, b) {
        return b.toUpperCase()
      })
      let g = c.replace(/[A-Z]/g, function (a) {
        return '-' + a.toLowerCase()
      })
      ba[z](g) ? (this.node.style[f] = a == null ? I : a) : d(this.node, e)
    }),
    ...
    let ca = function (a) {
      ...
      let f = e.clientTop || d.clientTop || 0
      let h = e.clientLeft || d.clientLeft || 0
      let i = b.top + (g.win.pageYOffset || e.scrollTop || d.scrollTop) - f
      let j = b.left + (g.win.pageXOffset || e.scrollLeft || d.scrollLeft) - h
      return { y: i, x: j }
    }
    return (
      (c.getElementByPoint = function (a, b) {
        ...
        if (y.win.opera && d.tagName == 'svg') {
          let e = ca(d)
          let f = d.createSVGRect()
            ;((f.x = a - e.x), (f.y = b - e.y), (f.width = f.height = 1))
          let g = d.getIntersectionList(f, null)
  ...
  return (
    d.plugin(function (c, d, e, f, g) {
      function h(a, b) {
        ...
        let e = c._.transform2matrix(b, a.getBBox(1))
      ...
      function i(a) {
        ...
        for (j = 0, k = h.length; k > j; j++) {
          let m = i[h[j].old]
          if (m) for (let n = 0, p = m.length; p > n; n++) m[n](h[j].id)
        }
      }
      function j(a) {
        return function () {
          let b = a ? '<' + this.type : ''
          let c = this.node.attributes
          let d = this.node.childNodes
          if (a) {
          ...
          if (d.length) {
            for (a && (b += '>'), e = 0, f = d.length; f > e; e++) {
              d[e].nodeType == 3
                ? (b += d[e].nodeValue)
                : d[e].nodeType == 1 && (b += s(d[e]).toString())
            }
            a && (b += '</' + this.type + '>')
          } else a && (b += '/>')
          return b
      ...
      var o = c._.$
      let p = c._.make
      let q = c._.getSomeDefs
      let r = 'hasOwnProperty'
      var s = c._.wrap
      k.getBBox = function (a) {
        if (this.type == 'tspan') return c._.box(this.node.getClientRects().item(0))
      ...
      (k.asPX = function (a, b) {
        return (b == null && (b = this.attr(a)), +n(this, a, b))
      }),
      (k.use = function () {
        let a
        let b = this.node.id
      ...
      let u = {}
        ;((k.data = function (a, d) {
        let e = (u[this.id] = u[this.id] || {})
        if (arguments.length == 0) return (b('snap.data.get.' + this.id, this, e, null), e)
        if (arguments.length == 1) {
          if (c.is(a, 'object')) {
            for (let f in a) a[r](f) && this.data(f, a[f])
            return this
          }
      ...
      (k.removeData = function (a) {
        return (a == null ? (u[this.id] = {}) : u[this.id] && delete u[this.id][a], this)
      }),
    ...
    d.plugin(function (a, d, e, f, g) {
      ...
      (i.animate = function (a, d, e, f) {
        ...
        let w = c(
          ...
          function (a) {
            let b = {}
            for (let c in r) r[l](c) && (b[c] = r[c](a))
            s.attr(b)
          },
          e
        )
    ...
    d.plugin(function (a, b, c, d, e) {
      function f(a, b, c, d, e, f) {
        return b == null && g.call(a) == '[object SVGMatrix]'
          ? ((this.a = a.a),
          (this.b = a.b),
          (this.c = a.c),
          (this.d = a.d),
      ...
      let j = ''
        ...
        ;((b.add = function (a, b, c, d, e, g) {
          ...
          let h = a * this.a + b * this.c
          let i = a * this.b + b * this.d
          return (
        ...
        (f.prototype.multLeft = function (a, b, c, d, e, g) {
          ...
          let h = a * this.a + c * this.b
          let i = a * this.c + c * this.d
          let j = a * this.e + c * this.f + e
          return (
        ...
        (b.rotate = function (b, c, d) {
          ...
          let e = +i.cos(b).toFixed(9)
          let f = +i.sin(b).toFixed(9)
        ...
        (b.skew = function (b, c) {
          ...
          let d = i.tan(b).toFixed(9)
          let e = i.tan(c).toFixed(9)
        ...
        (b.split = function () {
          ...
          return (
            g < 0
              ? ((b.rotate = a.deg(i.acos(g))), f < 0 && (b.rotate = 360 - b.rotate))
        ...
        (b.toTransformString = function (a) {
          ...
          return +b.shear.toFixed(9)
            ...
            (b.dx || b.dy ? 't' + [+b.dx.toFixed(4), +b.dy.toFixed(4)] : j) +
                    ...
                    (b.scalex != 1 || b.scaley != 1 ? 's' + [b.scalex, b.scaley, 0, 0] : j))
        }))
      })(f.prototype),
      (a.Matrix = f),
    ...
    d.plugin(function (a, c, d, e, f) {
      function g(d) {
        return function (e) {
          if (
            ...
            if (e.type == 'radialGradient' || e.type == 'linearGradient' || e.type == 'pattern') {
              e.node.id || p(e.node, { id: e.id })
              var g = q(e.node.id)
            } else g = e.attr(d)
          } else if (((g = a.color(e)), g.error)) {
            let h = a(n(this).ownerSVGElement).gradient(e)
      ...
      b.on('snap.util.attr.mask', function (a) {
        if (a instanceof c || a instanceof f) {
          if (
            ...
            a.type == 'mask')
          ) { var d = a } else ((d = k('mask', n(this))), d.node.appendChild(a.node))
        ...
        if (this.type == 'text') {
          for (
            var c = this.node,
              d = function (a) {
                let b = p('tspan')
                if (m(a, 'array')) for (let c = 0; c < a.length; c++) b.appendChild(d(a[c]))
      ...
      (function () {
        ...
        function d(a) {
          return function (c) {
            b.stop()
            let d = 'marker' + a.charAt(0).toUpperCase() + a.substring(1)
      ...
      b.on('snap.util.getattr.r', function () {
        return this.type == 'rect' && p(this.node, 'rx') == p(this.node, 'ry')
      ...
      b.on('snap.util.getattr.fill', function (c) {
        if (!c) {
          b.stop()
          let d = b('snap.util.getattr.fill', this, !0).firstDefined()
      ...
      b.on('snap.util.getattr.stroke', function (c) {
        if (!c) {
          b.stop()
          let d = b('snap.util.getattr.stroke', this, !0).firstDefined()
          return a(a.deurl(d)) || d
        }
      })(-1),
    ...
    d.plugin(function (a, c, d, e, f) {
      ...
      let j = String
      let k = /[a-z]+$/i
      let l = /^\s*([+\-\/*])\s*=\s*([\d.eE+\-]+)\s*([^\d\s]+)?\s*$/
        ;(b.on('snap.util.attr', function (a) {
        let c = j(a).match(l)
        if (c) {
          let d = b.nt()
          let e = d.substring(d.lastIndexOf('.') + 1)
          let f = this.attr(e)
          let g = {}
          b.stop()
          let h = c[3] || ''
    ...
    d.plugin(function (c, d, e, f, g) {
      ...
      let i = c.is
        ...
        return (
          f == null && (f = e),
          i(a, 'object') && a == '[object Object]'
            ? (g = a)
            : a != null &&
                ((g = { x: a, y: b, width: c, height: d }), e != null && ((g.rx = e), (g.ry = f))),
          this.el('rect', g)
        )
      }),
      ...
      let j = (function () {
        ...
        if (i(a, 'object') && 'src' in a) g.attr(a)
          ...
          let h = { 'xlink:href': a, preserveAspectRatio: 'none' }
            ;(b != null && d != null && ((h.x = b), (h.y = d)),
          e != null && f != null
      ...
      (h.svg = function (a, b, c, d, e, f, g, h) {
        ...
        return (
          i(a, 'object') && b == null
            ...
            c != null && (j.width = c),
            d != null && (j.height = d),
            e != null && f != null && g != null && h != null && (j.viewBox = [e, f, g, h])),
          this.el('svg', j)
        )
      }),
      (h.mask = function (a) {
      ...
      (h.symbol = function (a, b, c, d) {
        let e = {}
        return (
          a != null && b != null && c != null && d != null && (e.viewBox = [a, b, c, d]),
          this.el('symbol', e)
        )
      }),
      (h.text = function (a, b, c) {
        let d = {}
        return (
          i(a, 'object') ? (d = a) : a != null && (d = { x: a, y: b, text: c || '' }),
          this.el('text', d)
        )
      }),
      (h.line = function (a, b, c, d) {
        let e = {}
        return (
          i(a, 'object') ? (e = a) : a != null && (e = { x1: a, x2: c, y1: b, y2: d }),
          this.el('line', e)
        )
      }),
      (h.polyline = function (a) {
        ...
        let b = {}
        return (
          i(a, 'object') && !i(a, 'array') ? (b = a) : a != null && (b = { points: a }),
          this.el('polyline', b)
        )
      }),
      ...
      (function () {
        ...
        function e(a, b) {
          ...
          for (var f, g = this.stops(), h = 0; h < g.length; h++) {
            let i = parseFloat(g[h].attr('offset'))
            if (i > b) {
        ...
        function f() {
          if (this.type == 'linearGradient') {
            let a = l(this.node, 'x1') || 0
            let b = l(this.node, 'x2') || 1
            let d = l(this.node, 'y1') || 0
            let e = l(this.node, 'y2') || 0
            return c._.box(a, d, math.abs(b - a), math.abs(e - d))
          }
          let f = this.node.cx || 0.5
          let g = this.node.cy || 0.5
          let h = this.node.r || 0
        ...
        function g(a) {
          ...
          if (
            ...
            for (var f = 0; f < e.length; f++) {
              if (d[f]) {
                let g = c.color(d[f].color)
                let h = { offset: d[f].offset + '%' }
                    ;((h['stop-color'] = g.hex),
        ...
        function i(a, c) {
          let d
          let e = b('snap.util.grad.parse', null, c).firstDefined()
          if (!e) return null
          ;(e.params.unshift(a),
          (d = e.type.toLowerCase() == 'l' ? j.apply(0, e.params) : k.apply(0, e.params)),
          e.type != e.type.toLowerCase() && l(d.node, { gradientUnits: 'userSpaceOnUse' }))
          for (let f = e.stops, g = f.length, h = 0; g > h; h++) {
            let i = f[h]
        ...
        function j(a, b, h, i, j) {
          let k = c._.make('linearGradient', a)
          return (
            (k.stops = d),
            (k.addStop = e),
            (k.getBBox = f),
            (k.setStops = g),
            b != null && l(k.node, { x1: b, y1: h, x2: i, y2: j }),
            k
          )
        }
        function k(a, b, g, h, i, j) {
          let k = c._.make('radialGradient', a)
          return (
            (k.stops = d),
            (k.addStop = e),
            (k.getBBox = f),
            b != null && l(k.node, { cx: b, cy: g, r: h }),
            i != null && j != null && l(k.node, { fx: i, fy: j }),
            k
          )
        }
        var l = c._.$
        ...
        (h.toString = function () {
          let a
          let b = this.node.ownerDocument
          let d = b.createDocumentFragment()
          let e = b.createElement('div')
          let f = this.node.cloneNode(!0)
          return (
            d.appendChild(e),
            e.appendChild(f),
        ...
        (h.clear = function () {
          for (var a, b = this.node.firstChild; b;) {
            ((a = b.nextSibling),
            b.tagName != 'defs' ? b.parentNode.removeChild(b) : h.clear.call({ node: b }),
            (b = a))
          }
        }))
      })())
    ...
    d.plugin(function (a, b, c, d) {
      function e(a) {
        ...
        return (
          ...
          setTimeout(function () {
            for (let c in b) b[M](c) && c != a && (b[c].sleep--, !b[c].sleep && delete b[c])
          }),
          b[a]
        )
      }
      ...
      function j(c, d) {
        ...
        return a._.cacher(
          function (a, f, g) {
            ...
            return (
              (p.end = o),
              (n = c ? q : d ? p : k(h, j, l[0], l[1], l[2], l[3], l[4], l[5], 1))
            )
          },
          null,
          a._.clone
      ...
      function k(a, b, c, d, e, f, g, h, i) {
        ...
        let m = i * i
        let n = m * i
        let o = k * a + 3 * l * i * c + 3 * j * i * i * e + n * g
        let p = k * b + 3 * l * i * d + 3 * j * i * i * f + n * h
        let q = a + 2 * i * (c - a) + m * (e - 2 * c + a)
        let r = b + 2 * i * (d - b) + m * (f - 2 * d + b)
        let s = c + 2 * i * (e - c) + m * (g - 2 * e + c)
        let t = d + 2 * i * (f - d) + m * (h - 2 * f + d)
        let u = j * a + i * c
        let v = j * b + i * d
        let w = j * e + i * g
        let x = j * f + i * h
        let y = 90 - (180 * P.atan2(q - s, r - t)) / Q
        return {
          x: o,
          y: p,
          m: { x: q, y: r },
      ...
      function o(a, b, c, d, e) {
        let f = -3 * b + 9 * c - 9 * d + 3 * e
        let g = a * f + 6 * b - 12 * c + 6 * d
        return a * g - 3 * b + 3 * c
      }
      ...
      function r(a, b, c, d, e, f, g, h) {
        if (!(S(a, c) < R(e, g) || R(a, c) > S(e, g) || S(b, d) < R(f, h) || R(b, d) > S(f, h))) {
          let i = (a * d - b * c) * (e - g) - (a - c) * (e * h - f * g)
          let j = (a * d - b * c) * (f - h) - (b - d) * (e * h - f * g)
          let k = (a - c) * (f - h) - (b - d) * (e - g)
          if (k) {
            let l = i / k
            let m = j / k
            let n = +l.toFixed(2)
      ...
      function s(a, b, c) {
        ...
        for (s = 0; h > s; s++) {
          for (let u = 0; i > u; u++) {
            ...
            let x = m[u]
            let y = m[u + 1]
            let z = U(w.x - v.x) < 0.001 ? 'y' : 'x'
            let A = U(y.x - x.x) < 0.001 ? 'y' : 'x'
            let B = r(v.x, v.y, w.x, w.y, x.x, x.y, y.x, y.y)
            if (B) {
              if (o[B.x.toFixed(4)] == B.y.toFixed(4)) continue
              o[B.x.toFixed(4)] = B.y.toFixed(4)
              let C = v.t + U((B[z] - v[z]) / (w[z] - v[z])) * (w.t - v.t)
              let D = x.t + U((B[A] - x[A]) / (y[A] - x[A])) * (y.t - x.t)
              C >= 0 &&
                  C <= 1 &&
                  D >= 0 &&
                  D <= 1 &&
            ...
            for (let r = 0, t = b.length; t > r; r++) {
              ...
              if (u[0] == 'M') ((f = j = u[1]), (g = k = u[2]))
                ...
                if (c) n += v
                  ...
                  for (let w = 0, x = v.length; x > w; w++) { ((v[w].segment1 = o), (v[w].segment2 = r), (v[w].bez1 = l), (v[w].bez2 = m)) }
                  n = n.concat(v)
                }
              }
            }
      ...
      function x(a) {
        ...
        for (var c, d = 0, g = 0, h = [], i = [], j = 0, k = a.length; k > j; j++) {
          if (((c = a[j]), c[0] == 'M')) ((d = c[1]), (g = c[2]), h.push(d), i.push(g))
          else {
            let l = F(d, g, c[1], c[2], c[3], c[4], c[5], c[6])
      ...
      function y(a, b, c, d, e) {
        ...
        let f = [['M', a, b], ['l', c, 0], ['l', 0, d], ['l', -c, 0], ['z']]
        return ((f.toString = g), f)
      }
      function z(a, b, c, d, e) {
        if (
          (e == null && d == null && (d = c), (a = +a), (b = +b), (c = +c), (d = +d), e != null)
        ) {
          let f = Math.PI / 180
          let h = a + c * Math.cos(-d * f)
          let i = a + c * Math.cos(-e * f)
          let j = b + c * Math.sin(-d * f)
          let k = b + c * Math.sin(-e * f)
          var l = [
            ['M', h, j],
      ...
      function A(b) {
        let c = e(b)
        let d = String.prototype.toLowerCase
          ...
          if (q[0] != d.call(q[0])) {
            switch (((p[0] = d.call(q[0])), p[0])) {
              ...
              case 'm':
                ;((k = q[1]), (l = q[2]))
              default:
                for (let r = 1, s = q.length; s > r; r++) { p[r] = +(q[r] - (r % 2 ? i : j)).toFixed(3) }
            }
          } else {
      ...
      function B(b) {
        ...
        for (
          ...
          } else if (d == 'O') (f.pop(), (s = z(i, j, o[1], o[2])), s.push(s[0]), (f = f.concat(s)))
          else if (d == 'U') {
            (f.pop(),
            (f = f.concat(z(i, j, o[1], o[2], o[3]))),
            (n = ['U'].concat(f[f.length - 1].slice(-2))))
          } else for (let v = 0, w = o.length; w > v; v++) n[v] = o[v]
          if (((d = d.toUpperCase()), d != 'O')) {
            switch (n[0]) {
              case 'Z':
                ;((i = +k), (j = +l))
                break
      ...
      function E(b, c, d, e, f, g, h, i, j, k) {
        ...
        let n = (Q / 180) * (+f || 0)
        let o = []
        let p = a._.cacher(function (a, b, c) {
          let d = a * P.cos(c) - b * P.sin(c)
          let e = a * P.sin(c) + b * P.cos(c)
          return { x: d, y: e }
        })
        ...
        if (k) ((y = k[0]), (z = k[1]), (w = k[2]), (x = k[3]))
          ...
          let q = (P.cos((Q / 180) * f), P.sin((Q / 180) * f), (b - i) / 2)
          let r = (c - j) / 2
          ...
          var w = (v * d * r) / e + (b + i) / 2
          var x = (v * -e * q) / d + (c + j) / 2
          var y = P.asin(((c - x) / e).toFixed(9))
          var z = P.asin(((j - x) / e).toFixed(9))
            ;((y = w > b ? Q - y : y),
          (z = w > i ? Q - z : z),
          y < 0 && (y = 2 * Q + y),
          z < 0 && (z = 2 * Q + z),
      ...
      function F(a, b, c, d, e, f, g, h) {
        for (var i, j, k, l, m, n, o, p, q = [], r = [[], []], s = 0; s < 2; ++s) {
          if (
            (s == 0
              ? ((j = 6 * a - 12 * c + 6 * e),
              (i = -3 * a + 9 * c - 9 * e + 3 * g),
    ...
    d.plugin(function (a, d, e, f) {
      ...
      (j.attr = function (a) {
        let b = {}
        for (let c in a) this.bindings[c] ? this.bindings[c](a[c]) : (b[c] = a[c])
    ...
    d.plugin(function (a, c, d, e) {
      ...
      b.on('snap.util.equal', function (b, c) {
        ...
        if (b == 'transform' || b == 'gradientTransform' || b == 'patternTransform') {
          return (
            typeof c === 'string' && (c = r(c).replace(/\.{3}|\u2026/g, f)),
            (f = this.matrix),
        ...
        if (b == 'd' || b == 'path') { return ((d = a.path.toCubic(f, c)), { from: m(d[0]), to: m(d[1]), f: l(d[0]) }) }
        if (b == 'points') {
          return (
    ...
    d.plugin(function (a, c, d, e) {
      for (
        var f = c.prototype,
          ...
          k = function (a, b) {
            let c = a == 'y' ? 'scrollTop' : 'scrollLeft'
            let d = b && b.node ? b.node.ownerDocument : e.doc
          ...
          n = function (a, b, c, d) {
            ...
            let f = function (e) {
              ...
              let i = k('x', d)
              if (h && j[g](b)) {
                for (let n = 0, o = e.targetTouches && e.targetTouches.length; o > n; n++) {
    ...
    d.plugin(function (a, c, d, e) {
      ...
      (f.filter = function (b) {
        ...
        let e = a.parse(h(b))
        let f = a._.id()
        let g = (d.node.offsetWidth, d.node.offsetHeight, i('filter'))
        return (
      ...
      b.on('snap.util.attr.filter', function (d) {
        ...
        ;(d && d != 'none') || (b.stop(), this.node.removeAttribute('filter'))
      }),
      ...
      (a.filter.shadow = function (b, c, d, e, f) {
        return (
          f == null &&
                (e == null ? ((f = d), (d = 4), (e = '#000')) : ((f = e), (e = d), (d = 4))),
          d == null && (d = 4),
          f == null && (f = 1),
          b == null && ((b = 0), (c = 2)),
          c == null && (c = b),
      ...
      (a.filter.saturate = function (b) {
        return (
          b == null && (b = 1),
          a.format('<feColorMatrix type="saturate" values="{amount}"/>', { amount: 1 - b })
        )
      }),
      ...
      (a.filter.hueRotate = function (b) {
        return (
          (b = b || 0),
          a.format('<feColorMatrix type="hueRotate" values="{angle}"/>', { angle: b })
        )
      }),
    ...
    d.plugin(function (a, b, c, d, e) {
      ...
      let i = function () {
        ...
        ;(b == null && g(a, 'string') && ((b = a), (a = null)), (a = a || this.paper))
        let c = a.getBBox ? a.getBBox() : f(a)
        let d = this.getBBox()
        let e = {}
    ...
    d.plugin(function (b, c, d, e) {
      ...
      let w = '#EFEBE9#D7CCC8#BCAAA4#A1887F#8D6E63#795548#6D4C41#5D4037#4E342E#3E2723'
      let x = '#FAFAFA#F5F5F5#EEEEEE#E0E0E0#BDBDBD#9E9E9E#757575#616161#424242#212121'
      let y = '#ECEFF1#CFD8DC#B0BEC5#90A4AE#78909C#607D8B#546E7A#455A64#37474F#263238'
        ;((b.mui = {}),
      (b.flat = {}),
      (b.mui.red = f(g)),
      (b.mui.pink = f(h)),
      ...
      (b.importMUIColors = function () {
        for (let c in b.mui) b.mui.hasOwnProperty(c) && (a[c] = b.mui[c])
      }))
    }),
    d
  )
