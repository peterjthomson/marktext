...
You need to add the additional language dictionaries via _"Language & Region"_ in your system preferences pane.

### Windows spell checker

On Windows 10, you need to add additional language dictionaries via _"Language"_ in your _"Time & language"_ settings. Add the additional language(s) and download the _"Basic typing"_ language option for each language.
